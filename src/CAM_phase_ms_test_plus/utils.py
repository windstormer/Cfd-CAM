...
def print_seg_contour(result_path, img, ground_truth, final_seg_1x, final_seg_2x, img_name):
    ...
    plt.axis('off')
    contour = plt.contour(final_seg_1x, [0.5], colors='b')
    contour.collections[0].set_label("Final Segment 1x")
    contour = plt.contour(final_seg_2x, [0.5], colors='r')
    contour.collections[0].set_label("Final Segment 2x")
