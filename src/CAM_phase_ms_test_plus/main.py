...
if __name__ == '__main__':
    ...
    exp_name = f"{args.cam}_{args.modality}_{{{args.pretrained_path}}}.ms_test_plus"
    if args.suffix != None:
    ...
    if args.cam == 'CAM':
        cam_object = CAM(args, exp_name, encoder_model_type, gpuid)
    elif args.cam == 'ScoreCAM':
        cam_object = ScoreCAM(args, exp_name, encoder_model_type, gpuid)
    elif args.cam == 'CfdCAM':
        cam_object = CfdCAM(args, exp_name, encoder_model_type, gpuid)
    ...
    test_id = ['00183-66', '00300-98', '00459-66', '00472-52', '01119-42', '01232-108', '01284-113', '01388-118', '01468-50', '01573-101',
     '01612-100', '01560-97', '01486-92', '01303-97', '01189-72', '00207-48']
    ...
    if not args.selected_case_only:
        ...
        result_path = os.path.join(args.project_path, "results_wacv", exp_name, "result.log")
